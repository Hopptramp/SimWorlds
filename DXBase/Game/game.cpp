...
Game::Game(ID3D11Device* _pd3dDevice, HINSTANCE _hInstance) :m_playTime(0), m_myEF(nullptr)
{
	...
	DynamicCube* DYNcube = new DynamicCube();
	DYNcube->init(10, _pd3dDevice);
	DYNcube->SetPos(Vector3(0.0f, 0.0f, -200.0f));
	DYNcube->SetScale(50.0f);
	m_GameObjects.push_back(DYNcube);
